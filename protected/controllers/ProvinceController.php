	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','loadprovinces'),
				'users'=>array('@'),
			),
        ...
        public function actionLoadprovinces()
{
         ...
         if(isset($_POST['physical_address_country_id'])){
             
             $country_id = $_POST['physical_address_country_id'];
         }
         else if($_POST['mailing_address_country_id']){
             
             $country_id = $_POST['mailing_address_country_id'];
         }
	//print_r($_POST); exit;
